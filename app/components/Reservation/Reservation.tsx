...
const Reservation = () => {
  return (
    <div
      className='pt-[5rem] bg-center bg-cover relative mt-[2rem] pb-[5rem] mb-[3rem] 
      bg-[url("/images/bg-black.jpg")]'>
      <div
        className='absolute w-full h-full bg-[#000000a6] 
      ...
      <div
        ...
        <div>
          ...
          <p className='text-[17px] mt-[1rem] text=white text-opacity-50'>
            ...
            repudiandae itaque repellendus vel cupiditate, accusantium veritatis
            amet, neque nulla sequi quas, voluptate iure expedita!
          </p>
          <div className='flex mt-[2rem] items-center space-x-4'>
            <div
              className='w-[3rem] h-[3rem] bg-red-500 rounded-full
